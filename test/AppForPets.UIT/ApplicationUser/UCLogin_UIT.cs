using AppForMovies.UIT.ApplicationUser;
...
namespace AppForPets.UIT.ApplicationUser
{
    public class UCLogin_UIT :IDisposable
    {
        ...
        [Theory]
        [InlineData("fulanito@uclm.com", "password1")]
        [InlineData("pepito@uclm.com", "password2")]
        [InlineData("menganito@uclm.com", "password2")]
