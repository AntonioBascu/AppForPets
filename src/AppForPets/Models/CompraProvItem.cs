...
namespace AppForPets.Models
{
    public class CompraProvItem
    {
        ...
        public override bool Equals(Object obj)
        {
            ...
            if ((this.Cantidad == purchaseItem.Cantidad) && (this.Compra.IdCompraProveedor == purchaseItem.Compra.IdCompraProveedor) && (this.ProductoProveedor.Equals(purchaseItem.ProductoProveedor)))
                return true;
            return false;
        }
