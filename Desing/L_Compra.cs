...
namespace Desing
{
    public class L_Compra
    {
        ...
        public override bool Equals(Object obj)
        {
            ...
            if ((this.Cantidad == l_compra.Cantidad)
                && (this.CompraID == l_compra.CompraID)
                && (this.AnimalID == l_compra.AnimalID)
                && (this.Animal == l_compra.Animal)
                && (this.Compra == l_compra.Compra))
